...
###Import data
trainDf <- read.csv("C:\\Manisha\\Stat II\\Project2\\train.csv", header = TRUE)
testDf <- read.csv("C:\\Manisha\\Stat II\\Project2\\test.csv", header = TRUE)
summary(trainDf)
...
rowPerc(xtabs(~income+workclass, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+education, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+marital_status, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+occupation, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+race, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+sex, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+ global_region, trainDf))#Variable of Interest
...
rowPerc(xtabs(~income+ hours_per_week_category, trainDf))#Variable of Interest
...
rowPerc(summary(trainDf$income))
